        ...
        <div class="wrapper">
            <nav id="sidebar" class="sidebar js-sidebar">
                <div class="sidebar-content js-simplebar">
                  ...
                  <i class="align-middle" data-feather="user"></i> <span class="align-middle">Profile</span>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('Ptasks.index') }}">
            ...
            <div class="main">
              ...
              <i class="hamburger align-self-center"></i>
                    ...
                    <img src= "{{ asset('assets/img/avatars/avatar-4.jpg') }}" alt="Wissal charraki" class="avatar img-fluid rounded me-1" width="128" height="128" /> <span class="text-dark">@if (session()->has('user.FullName')){{ session('user.FullName') }}@endif</span>
                  </a>
